...
import { Typography, Paper } from '../../components/Wrappers/Wrappers';
...
export default function GridComp() {
  ...
  <Box display="flex" flexDirection="column">
    <Box display="flex" flexDirection="row" justifyContent="flex-end">
      <Grid item xs={3}>One</Grid>
      <Grid item xs={3}>Two</Grid>
    </Box>
    <Box display="flex" flexDirection="row" justifyContent="flex-around">
      <Grid item xs={3}>Three</Grid>
      <Grid item xs={3}>Four</Grid>
    </Box>
    <Box display="flex" flexDirection="row" justifyContent="flex-between">
      <Grid item xs={3}>Five</Grid>
      <Grid item xs={3}>Six</Grid>
      <Grid item xs={3}>Seven</Grid>
    </Box>
  </Box>
                  `}
                </Code>
        ...
        <Grid item xs={12}>
          <ExtraLink
            title="Design Link"
            subtitle="This component uses the Grid Material UI Component"
